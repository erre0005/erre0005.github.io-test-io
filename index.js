...
/*
Task 2
Access the 13th div with class name box that belongs to div with the class name bg-main-content.
...
After the loop, use alert to print collect
*/
//let when_to_launch = document.getElementsByClassName(`.bg-main-content box`);
